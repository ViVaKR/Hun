...
clang --target=aarch64-none-elf -ffreestanding -nostdlib -I. -c vectors.S -o vectors.o
clang --target=aarch64-none-elf -ffreestanding -nostdlib -I. -c func_table.S -o func_table.o
clang --target=aarch64-none-elf -ffreestanding -nostdlib -c gic.c -o gic.o
