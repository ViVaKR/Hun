...
// ---- ★ 추가: AP[2:1] 데이터 접근 권한 필드 (비트[7:6]) ----
// 00(기본값) = EL1 R/W, EL0 접근 불가  ← 지금까지 상태
// 01         = EL1 R/W, EL0 R/W       ← 오늘 이걸로 EL0 강하를 허용
#define MM_AP_EL0_RW (1ULL << 6)
...
// ★ AP_EL0을 일부러 안 넣음 — UART/GIC는 EL0이 직접 만지면 안 되고 반드시 syscall(SVC)을 거쳐야 함!
